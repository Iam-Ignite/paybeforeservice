      ...
      <footer className="bg-primary">
        <div className="px-[60px] sm:px-5 w-full pt-[60px] pb-[100px] gap-[60px] flex flex-row justify-start md:flex-col-reverse">
          <div className="left flex-[1.5] max-w-[420px]">
            <h2 className="text-[24px] font-ui-bold text-white  mb-[10px] sm:text-center">
              SwiftSettle
            </h2>
            <p className="text-[14px] w-[97%] text-white font-ui-regular mb-[20px] sm:text-center">
              Explore a simplified approach to effortless money transfers with
              Swiftsettle. Enjoy fast, secure transactions via personalized
              payment links. Begin now for a seamless journey!
            </p>
          ...
          <div className="right flex-[2] w-fit sm:flex-1 sm:w-full">
            <ul className="flex gap-[40px] font-ui-regular text-[14px] text-white list-none sm:flex-col sm:text-center">
              <li>
                <h3 className="font-ui-semi text-[20px] text-white mb-5">
                  Features
                </h3>
