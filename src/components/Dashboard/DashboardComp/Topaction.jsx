export default function Topaction({ setPaymentModal, setWithdrawModal }) {
  return (
    <div className="flex w-100 items-center justify-between">
      ...
      <div className=" cursor-pointer flex md:grid md:grid-cols-2 gap-2 items-center justify-center md:w-full">
        ...
        <div
          ...
          className="cursor-pointer bg-[#A23EFF] flex justify-center items-center text-[#FFF] md:rounded-full 2xl:rounded-full px-6 md:py-4 2xl:py-3"
        >
          <i className="mr-1">
