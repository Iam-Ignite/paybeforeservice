            ...
            :
              <ul className='font-ui-regular text-[14px] text-body-text'>
                    <li className='flex w-full justify-between mb-[15px] modal:flex-col'>
                        <h3>Account Name</h3>
                        <h5 className='font-ui-semi text-black'>{paymentDetails.accountName }</h5>
                    </li>
                    <li className='flex w-full justify-between mb-[15px] modal:flex-col'>
                        <h3>Account Number</h3>
                        <h5 className='font-ui-semi text-black'>{ paymentDetails.accountNumber}</h5>
                    </li>
                    <li className='flex w-full justify-between mb-[15px] modal:flex-col'>
                        <h3>Bank Name</h3>
                     ...
                     <li className='flex w-full justify-between mb-[15px] modal:flex-col'>
                        <h3>Payment ID</h3>
                        <h5 className='font-ui-semi text-black'>{paymentDetails.payId}</h5>
                    </li>
                      <li className='flex w-full justify-between mb-[15px] modal:flex-col'>
                        <h3>Expiration Time</h3>
                        <h5 className='font-ui-semi text-black'>{formatDate(paymentDetails.expiration)}</h5>
                    </li>
                    <li className='flex w-full justify-between modal:flex-col'>
                        <h3>Amount</h3>
                        <h5 className='font-ui-semi text-primary'>₦{paymentDetails.amount}</h5>
                    </li>
                </ul>
               }
