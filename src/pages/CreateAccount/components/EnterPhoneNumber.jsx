...
const EnterPhoneNumber = () => {
  return (
    <Container>
      <h3 className="font-ui-semi text-[24px] text-[##0D0033] mb-5 text-center sm:text-[20px]">
      ...
      <p className="text-center font-ui-regular text-[14px] text-body-text my-5">
        When you press 'continue,' Swiftsettle will send you a text message with
        a verification code. This might cost you some money for messaging and
        data. You can use the verified phone number to log in
      </p>
      <ContinueBtn />
    </Container>
  );
