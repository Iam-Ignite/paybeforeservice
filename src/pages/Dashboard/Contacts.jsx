  ...
  return (
    <div className="flex flex-col p-14 gap-2 px-28 md:px-8">
      ...
      <p className="text-[#555555] text-left">
        If you require assistance with understanding Swiftsettle&apos;s
        operation or encounter technical issues, we encourage you to review our
        Frequently Asked Questions (FAQs).
      </p>
      <p className="text-[#555555] text-left">
        If you couldn&apos;t locate the information you need, kindly fill out
        the form below with as much detail as possible, ensuring your email
        address is accurate. We anticipate receiving your inquiry and are eager
        to assist you
      </p>
