...
const Accordion = ({ question, answer }) => {
  ...
  return (
    <div className="transition-all duration-500">
      {!dropDown && (
        <div
          className="flex justify-between items-center border-border border-ui-border w-full px-[20px] py-[15px] rounded-[16px]"
      ...
      {dropDown && (
        <div className={`bg-primary px-[20px] py-[15px] rounded-[16px]`}>
          <div
            className="flex justify-between mb-[17px]"
