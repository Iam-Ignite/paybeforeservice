...
export const Txtype = ({data}) => {
    return (
      <div className="font-semibold text-[#0D0033]">
         Received from client     
      </div>
    )
}

export const Txdate = ({data}) => {
    return (
...
export const Txstatus = ({data}) => {
    return (
    <div className="bg-[#a23eff33] flex justify-center items-center rounded-[18px] px-2 py-1 text-center">
        <span className='text-[#A23EFF] font-medium'>Pending</span>
     </div>
    )
}


export const Txbalance = ({data}) => {
    return (
    <div className="text-[#0D0033] font-bold">
        ₦5,000.00
    </div>
    )
}
...
export const Txbutton = ({data}) => {
    return (
    <div className="bg-[#A23EFF] px-3 py-2 rounded-[20px]">
       Redeem
    </div>
    )
}
